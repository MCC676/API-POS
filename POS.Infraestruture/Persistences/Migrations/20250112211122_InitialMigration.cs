    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Departme__B2079BEDE915DC44", x => x.DepartmentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    //table.PrimaryKey("PK__Document__DBA390E18BE99EFE", x => x.DocumentTypeId);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Menus__C99ED2300A31382E", x => x.MenuId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Roles__8AFACE1A4A6EB38F", x => x.RoleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Province__FD0A6F83C85CC9B8", x => x.ProvinceId);
                    table.ForeignKey(
                        name: "FK__Provinces__Depar__656C112C",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Clients__E67E1A24A554C60B", x => x.ClientId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MenuRole__6640AD0C343B7EAC", x => x.MenuRolId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__District__85FDA4C6CBF5106A", x => x.DistrictId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Sales__1EE3C3FFDB03EA4D", x => x.SaleId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK__Sales__UserId__6D0D32F4",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6CD3A424A5F", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK__Products__Catego__628FA481",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchars__A98C674B1032F6BF", x => x.PurcharseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Business__F1EAA36EBF804EDE", x => x.BusinessId);
                    table.ForeignKey(
                        name: "FK__Business__Distri__5DCAEF64",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SaleDeta__70DB14FEAC09EB35", x => x.SaleDetailId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK__SaleDetai__SaleI__6B24EA82",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchars__7353248B683F784C", x => x.PurcharseDetailId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BranchOf__27247FF93EEE0B58", x => x.BranchOfficeId);
                    table.ForeignKey(
                        name: "FK__BranchOff__Busin__5BE2A6F2",
                        column: x => x.BusinessId,
                        principalTable: "Business",
                        principalColumn: "BusinessId");
                    table.ForeignKey(
                        name: "FK__BranchOff__Distr__5CD6CB2B",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "DistrictId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserRole__3D978A35FEBB3099", x => x.UserRoleId);
                    table.ForeignKey(
                        name: "FK__UserRoles__Branc__6E01572D",
                        column: x => x.BranchOfficeId,
                        principalTable: "BranchOffices",
                        principalColumn: "BranchOfficeId");
                    table.ForeignKey(
                        name: "FK__UserRoles__RoleI__6EF57B66",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "RoleId");
                    table.ForeignKey(
                        name: "FK__UserRoles__UserI__6FE99F9F",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UsersBra__7D1E804A0677F4BA", x => x.UserBranchOfficeId);
                    table.ForeignKey(
                        name: "FK__UsersBran__Branc__70DDC3D8",
                        column: x => x.BranchOfficeId,
                        principalTable: "BranchOffices",
                        principalColumn: "BranchOfficeId");
                    table.ForeignKey(
                        name: "FK__UsersBran__UserI__71D1E811",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
